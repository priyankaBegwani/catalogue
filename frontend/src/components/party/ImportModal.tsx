        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <div className="space-y-1 text-xs text-blue-800">
              ...
              <p><strong>Optional Columns:</strong> Description, Address, City, District, State, Pincode, Phone Number, Email ID, GST Number, Grade, Preferred Transport 1, Preferred Transport 2, Default Discount</p>
              <p><strong>Note:</strong> Column names must match exactly (case-sensitive)</p>
              <p><strong>Grade Values:</strong> A+, A, B, C, D</p>
              <p><strong>Discount Values:</strong> gold, silver, copper, retail</p>
            </div>
          </div>
