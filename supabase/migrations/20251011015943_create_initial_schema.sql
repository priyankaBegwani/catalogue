/*
  ...
  - A trigger automatically creates user_profiles when auth.users are created
*/
...
-- Create a trigger function to automatically create user profile on auth signup
